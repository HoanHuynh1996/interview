1.How to run the test by your sel -> run below command:
npx playwright test
...
o What is your testing strategy?
...
o Which cases did you generate? And why?
...
o Information about the test automation framework (libraries used etc.)
...
o Explanation about how to run tests in your framework.
...
o Which test design techniques did you use?
->I used boundary value analysis and equivalence partitioning
o What patterns did you use while coding?
...
-the list of returned movies are not correct 
+filter Animation under Genre returns other Genres
+return the movie is not within the range of Year filter 
